<template>
  <Layout>
      ...
      <div class="w-full sm:w-full md:w-3/5">
        ...
        <div class="flex flex-col text-gray-800 font-semibold">
          ...
          <div class="flex items-center">
            ...
            <div class="flex-1">Increased perspiration</div>
          </div>
    ...
    <footer class='mt-12 w-full text-center border-t border-grey-500 p-4'>
    <p class="text-sm uppercase text-gray-500 font-semibold">
        © {{ new Date().getFullYear() }} Toast Masters | Hays,KS
      </p>   
    </footer>
  </Layout>
</template>
